...
tinyMceWysiwygSetup.prototype =
{
    ...
    getSettings: function(mode)
    {
        ...
        var settings = {
            ...
            /* JETPULP
             * ajout des attributs itemscope, itemtype et itemprop
             * redéfinition en passant par l'option valide_elements, extends_valide_elements ne fonctionnant pas
             */
            valid_elements : "@[itemscope|itemtype|itemprop|id|class|style|title|dir<ltr?rtl|lang|xml::lang|onclick|ondblclick|"
            ...
            setup : function(ed) {
                ...
                ed.onSetContent.add(function(ed, o) {
                    ...
                    /* JETPULP
                     * ajout des attributs itemscope, itemtype et itemprop
                     * nettoyage spécifique sur l'attribut itemscrop qui n'a pas de valeur
                     */
                    o.content = o.content.replace('itemscope=""', 'itemscope');
                });
