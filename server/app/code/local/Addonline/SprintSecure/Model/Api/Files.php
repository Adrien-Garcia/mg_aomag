...
class Addonline_SprintSecure_Model_Api_Files extends Addonline_SprintSecure_Model_Abstract
{
    public function getPathfileName($merchand_id = null)
	{
	  ...
	  if ( is_dir($path) ) 
	  {
		  ...
		  if (!file_exists($pathfile)) 
		  {
		      ...
		      $content.= '# Pathfile' . "\n";
		      $content.= '#' . "\n";
		      $content.= '# Liste fichiers parametres utilis�s par le module de paiement' . "\n";
		      $content.= '#' . "\n";
		      $content.= '#########################################################################' . "\n";
		      $content.= "\n";
		      $content.= '# ------------------------------------------------------------------------'. "\n";
		      $content.= '# Chemin vers le r�pertoire des logos depuis le web alias' . "\n";
		      $content.= '# Exemple pour le r�pertoire www.merchant.com/cyberplus/payment/logo/' . "\n";
		      $content.= '# indiquer:' . "\n";
		      $content.= '# ------------------------------------------------------------------------' . "\n";
		      $content.= '#' . "\n";
	          ...
	          $content.= '#' . "\n";
	          $content.= '# Fichier param�tre commercant' . "\n";
	          $content.= '#' . "\n";
	          $content.= 'F_PARAM!' . $path . 'parmcom!' . "\n";
	          $content.= '#' . "\n";
	          $content.= '# Fichier des param�tres communs' . "\n";
	          $content.= '#' . "\n";
