...
/**
 * Replace Mage_Adminhtml_Block_Promo_Quote_Edit_Tab_Actions :
 * Adds the GiftProduct option ine the quote rules combo
 *
 * @category    Addonline
 * @category   Addonline
 * @package    Addonline_GiftProduct
 * @author      spras
 */
class Addonline_GiftProduct_Block_Adminhtml_Promo_Quote_Edit_Tab_Actions
