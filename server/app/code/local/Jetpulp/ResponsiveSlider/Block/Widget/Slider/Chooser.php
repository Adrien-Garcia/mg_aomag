<?php
class Jetpulp_ResponsiveSlider_Block_Widget_Slider_Chooser extends Mage_Adminhtml_Block_Widget_Grid
{
    /**
    ...
    public function prepareElementHtml(Varien_Data_Form_Element_Abstract $element)
    {
        ...
        $sourceUrl = $this->getUrl('*/responsiveslider/chooser', array('uniq_id' => $uniqId));
        ...
        if ($element->getValue()) {
            $slider = Mage::getModel('responsiveslider/responsiveslider')->load((int)$element->getValue());
            if ($slider->getId()) {
    ...
    {
        return $this->getUrl('*/responsiveslider/chooser', array('_current' => true));
    }
}
