...
class Jetpulp_ResponsiveSlider_Model_Image extends Mage_Core_Model_Abstract
{
    protected $_width;
    protected $_height;
    ...
    /**
     * @return Jetpulp_ResponsiveSlider_Model_Image
     */
...
//        print '$this->_getNeedMemoryForBaseFile() = '.$this->_getNeedMemoryForBaseFile();
    ...
    public function setBaseFile($file)
    {
        ...
        $this->_newFile = implode('/', $path) . str_replace("responsiveslider/", "", $file); // the $file contains heading slash
...
//            }
    ...
    {
        $directory = Mage::getBaseDir('media') . DS.'responsiveslider'.DS.'cache'.DS;
