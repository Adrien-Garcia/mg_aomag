...
class Jetpulp_Checkout_OnepageController extends Mage_Checkout_Controller_Action
{
    /**
     ...
     *
     * @return Jetpulp_Checkout_OnepageController
     */
    ...
    /**
     * Get shipping type step html
     *
     * @return string
     */
    protected function _getShippingTypeHtml()
    {
        $layout = $this->getLayout();
        $update = $layout->getUpdate();
        $update->load('checkout_onepage_shippingtype');
        $layout->generateXml();
        $layout->generateBlocks();
        $output = $layout->getOutput();
        return $output;
    ...
    /**
     * Save checkout Informations (Custom Billing)
     */
    ...
    /**
     * load shipping types action
     */
    public function loadShippingTypeAction()
    {
        if ($this->_expireAjax()) {
            return;
        }
