...
class Mage_Eav_Model_Entity_Attribute_Source_Table extends Mage_Eav_Model_Entity_Attribute_Source_Abstract
{
    ...
    /**
     * ADDONLINE : optimisation (for product list pages and product page)
     * see http://turnkeye.com/blog/magento-perfomance-optimization-of-configurable-products/
     * Retrieve Atribute Options Needed by the configurable attribute
     * Called in Mage_Catalog_Model_Resource_Product_Type_Configurable_Attribute_Collection#_loadPrices
     *
    ...
    /**
     * ADDONLINE : Optimisations (for checkout/cart page)
     * see http://turnkeye.com/blog/magento-perfomance-optimization-of-configurable-products/
     *
     * Get a text for option value
     *
