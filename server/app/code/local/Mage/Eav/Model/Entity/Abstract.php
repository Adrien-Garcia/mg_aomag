    ...
    implements Mage_Eav_Model_Entity_Interface
{
    ...
    /**
     * JETPLUP
     * Array of attributes sorted by Set Id (cache optimisation)
     * see https://gist.github.com/manelio/5791101c513bf2d5d531
     * @var array
     */
     ...
     * @return array
     */
    public function _getSortedAttributes($setId = null)
    {
    ...
    public function walkAttributes($partMethod, array $args = array())
    {
        ...
        foreach ($this->getAttributesByCode() as $attrCode => $attribute) {
            ...
            try {
                ...
                /** @var Mage_Eav_Model_Entity_Attribute_Exception $e */
