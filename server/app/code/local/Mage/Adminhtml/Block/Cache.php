...
class Mage_Adminhtml_Block_Cache extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    ...
    public function __construct()
    {
        ...
        //JETPULP : addslash to javascript message
        $message = addslashes(Mage::helper('core')->__('Cache storage may contain additional data. Are you sure that you want flush it?'));
        //JETPULP 
