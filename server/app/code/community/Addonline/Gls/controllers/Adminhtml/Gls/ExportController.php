 ...
 * @author Addonline (http://www.addonline.fr)
 */
class Addonline_Gls_Adminhtml_Gls_ExportController extends Mage_Adminhtml_Controller_Action
{
    /*
    ...
    {
        return Mage::getSingleton('admin/session')->isAllowed('gls/export');
    }
