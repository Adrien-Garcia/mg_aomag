...
//
// 04/05/2011 Jean Baptiste Coquet : ajout des options minWidth et minHeight pour ne pas déclancher la loupe en dessous d'une certaine taille 
//
//////////////////////////////////////////////////////////////////////////////////
(function($){$(document).ready(function(){});function format(str){for(var i=1;i<arguments.length;i++){str=str.replace('%'+(i-1),arguments[i])}
return str}
...
zoomDiv.fadeOut(300,function(){ctx.fadedOut()});return false});$mouseTrap.bind('mouseenter',this,function(event){if(opts.minWidth!=null&&zoomImage.width<opts.minWidth)return;if(opts.minHeight!=null&&zoomImage.height<opts.minHeight)return;mx=event.pageX;my=event.pageY;zw=event.data;if(zoomDiv){zoomDiv.stop(true,false);zoomDiv.remove()}
